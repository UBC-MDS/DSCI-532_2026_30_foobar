...
Conduct](CODE_OF_CONDUCT.md). By participating in this project you agree to its terms.
...
*  YES: you edit a comment or a small update in the README.
*  NO: you edit the code of an `.py`, `.ipynb`, or anything that will be run.
